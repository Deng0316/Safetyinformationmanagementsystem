        ...
        <div class="addBox" style="background:#fff;opacity:0.9">
            ...
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="uname" id="user-add-uname" lay-verify="required" placeholder="用户名" readonly class="layui-input" value="${requestScope.user==null?'':requestScope.user.uname}">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="user-add-submit">修 改</button>
                </div>
            </div>
        </div>
    </form>
